...
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    user_type = serializers.ChoiceField(choices=[('skillSeeker', 'Skill Seeker'), ('skillCrafter', 'SkillCrafter')], required=True)
    ...
    def save(self):
        ...
        if user_type == 'skillSeeker':
            # SkillSeeker.objects.create(user = account) 
        ...
        if user_type == 'skillSeeker':
            ...
            SkillCrafter.objects.create(user = account)
